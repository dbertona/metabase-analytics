...
def persist_dashboard_config(
    ...
    dashboard_css = (
        ...
        "}\n"
        "/* Tablas: layout en columna; ⋮ en franja de cabecera reservada */\n"
        "/* SELECTOR CORRECTO Superset 6.x: data-test en vez de clase slice_header */\n"
        ...
        "  overflow: hidden !important;\n"
        "}\n"
        "/* [data-test=slice-header] es el real en Superset 6.x (no .slice_header) */\n"
        ".dashboard-component-chart-holder[data-test-chart-name*='Resumen mensual']"
        ...
        "}\n"
        "/* titulo: crece pero no pisa los controles */\n"
        ".dashboard-component-chart-holder[data-test-chart-name*='Resumen mensual']"
        ...
        "  overflow: hidden !important;\n"
        "}\n"
        "/* controls: mantener visibles, alineados a la derecha del header */\n"
        ".dashboard-component-chart-holder[data-test-chart-name*='Resumen mensual']"
        ...
        "[data-test-chart-name*='Proyectos'] .chart-slice,\n"
