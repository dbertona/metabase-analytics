...
def persist_dashboard_config(
    ...
    dashboard_css = (
        ...
        "}\n"
        "/* Facturación por Probabilidad: título más grande */\n"
        "[data-test-chart-name*='Facturación por Probabilidad'] .header-title,\n"
        "[data-test-chart-name*='Facturación por Probabilidad'] .header-title a,\n"
        "[data-test-chart-name*='Facturación por Probabilidad'] .editable-title,\n"
        "[data-test-chart-name*='Facturación por Probabilidad'] .editable-title a,\n"
        "[data-test-chart-name*='Facturación por Probabilidad'] .editable-title span {\n"
