...
def persist_dashboard_config(
    ...
    dashboard_css = (
        ...
        "  overflow: hidden !important;\n"
        "}\n"
        "/* Tablas: estilo nativo limpio (sin rejilla lateral) */\n"
        ...
        "  background: transparent !important;\n"
        "}\n"
        "/* Cabeceras: fondo suave, sin bordes laterales, sin wrap */\n"
        ...
        "  text-align: left !important;\n"
        "}\n"
        "/* Celdas de datos: solo borde inferior, sin laterales */\n"
        "[data-test-chart-name*='Resumen mensual'] tbody td,\n"
        "[data-test-chart-name*='Proyectos'] tbody td {\n"
        "  font-family: 'Segoe UI', -apple-system, Roboto, Helvetica, Arial, sans-serif !important;\n"
        ...
        "  background: #f8fafc !important;\n"
        "}\n"
        "/* Ocultar barras de color internas */\n"
        ...
        "}\n"
        "/* slice_container: scrollbar invisible para no robar ancho */\n"
