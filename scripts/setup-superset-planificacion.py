...
def persist_dashboard_config(
    ...
    dashboard_css = (
        ...
        "  display: none !important;\n"
        "}\n"
        "/* Cabeceras: sin wrap + borde inferior + fuente (+20% luego +30% → 1.56em) */\n"
        ...
        "}\n"
        "/* Celdas: font 1.56em (table + AG Grid) */\n"
        ...
        "  font-size: 1.56em !important;\n"
        "}\n"
        "/* Proyectos: Buscar pegado al titulo (no a la derecha) */\n"
        "[data-test-chart-name*='Proyectos'] [data-test='slice-header'] {\n"
        "  display: flex !important;\n"
        ...
        "  gap: 10px !important;\n"
        "}\n"
        "[data-test-chart-name*='Proyectos'] [data-test='slice-header'] .header-title,\n"
        "[data-test-chart-name*='Proyectos'] [data-test='slice-header'] .editable-title {\n"
        "  order: 1 !important;\n"
        "  flex: 0 0 auto !important;\n"
        "  margin-right: 0 !important;\n"
        "}\n"
        "[data-test-chart-name*='Proyectos'] [data-test='slice-header'] .search-container {\n"
        "  order: 2 !important;\n"
        ...
        "}\n"
        "[data-test-chart-name*='Proyectos'] [data-test='slice-header'] .input-wrapper,\n"
        "[data-test-chart-name*='Proyectos'] [data-test='slice-header'] .input-container {\n"
        "  margin: 0 !important;\n"
        "  margin-left: 0 !important;\n"
        "  width: auto !important;\n"
        "}\n"
        "[data-test-chart-name*='Proyectos'] [data-test='slice-header'] .input-wrapper input {\n"
        "  width: 180px !important;\n"
        "  background: #fff !important;\n"
        "}\n"
        "[data-test-chart-name*='Proyectos'] [data-test='slice-header'] .header-controls {\n"
        "  order: 99 !important;\n"
