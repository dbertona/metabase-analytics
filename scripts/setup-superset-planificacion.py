...
def persist_dashboard_config(
    ...
    dashboard_css = (
        ...
        "}\n"
        "/* Charts/tablas: un poco más de aire interno */\n"
        ".dashboard-component-chart-holder:not("
        ":has(.superset-legacy-chart-big-number)) {\n"
        "  padding: 4px 6px 6px !important;\n"
        "}\n"
        "/* Tablas: menos margen derecho (equilibrar vs izquierda) */\n"
        ...
        "[data-test-chart-name*='Resumen mensual'] [class*='Table'],\n"
        "[data-test-chart-name*='Proyectos'] [class*='Table'] {\n"
        "  width: 100% !important;\n"
        "  max-width: 100% !important;\n"
        "  margin-right: 0 !important;\n"
        "  box-sizing: border-box !important;\n"
