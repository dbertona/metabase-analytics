...
def persist_dashboard_config(
    ...
    dashboard_css = (
        ...
        "}\n"
        "/* Ocultar cabecera KPI (título + filtro + menú ⋮); etiqueta va en subheader */\n"
        ...
        "  line-height: 1.2 !important;\n"
        "}\n"
        "/* Tarjetas KPI: padding mínimo + sin scroll vertical */\n"
        ".dashboard-component-chart-holder:has(.superset-legacy-chart-big-number) {\n"
