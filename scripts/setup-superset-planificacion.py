...
def persist_dashboard_config(
    ...
    dashboard_css = (
        ...
        "}\n"
        "/*\n"
        " * Alto del dashboard según resolución (sin JS).\n"
        " * 100dvh se adapta a la pantalla; --ps-dash-chrome resta cabecera+filtros+tabs.\n"
        " */\n"
        ":root {\n"
        "  --ps-dash-chrome: 148px;\n"
        "  --ps-dash-h: calc(100dvh - var(--ps-dash-chrome));\n"
        "}\n"
        "@media (max-height: 800px) {\n"
        "  :root { --ps-dash-chrome: 132px; }\n"
        "}\n"
        "@media (min-height: 1100px) {\n"
        "  :root { --ps-dash-chrome: 160px; }\n"
        "}\n"
        "#dashboard-view,\n"
        ".dashboard-builder-view,\n"
        ".dashboard-content,\n"
        ".grid-content {\n"
        "  height: var(--ps-dash-h) !important;\n"
        "  max-height: var(--ps-dash-h) !important;\n"
