...
def persist_dashboard_config(
    ...
    dashboard_css = (
        ...
        "  height: calc(var(--ps-gastos-h) - 36px) !important;\n"
        "  max-height: calc(var(--ps-gastos-h) - 36px) !important;\n"
        "  min-height: calc(var(--ps-gastos-h) - 36px) !important;\n"
        "}\n"
        ...
        "}\n"
        "/*\n"
        " * Panel de filtros izquierdo: el contenido (~+80px) con overflow:visible\n"
        " * ensanchaba el documento y provocaba scroll vertical de página.\n"
        " * Scroll interno del panel; la página no se mueve.\n"
        " */\n"
        ...
        "}\n"
        "[data-test='dashboard-filters-panel'] > div {\n"
        "  max-height: 100% !important;\n"
        "  overflow-x: hidden !important;\n"
        "  overflow-y: auto !important;\n"
        "}\n"
