...
def persist_dashboard_config(
    ...
    dashboard_css = (
        ...
        "  font-size: 1.56em !important;\n"
        "}\n"
        "/* Proyectos: Buscar al lado del titulo (misma fila que slice-header) */\n"
        ...
        "}\n"
        "[data-test-chart-name*='Proyectos'] .dropdown-controls-container {\n"
        ...
        "  pointer-events: none !important;\n"
        "}\n"
        "[data-test-chart-name*='Proyectos'] .search-container {\n"
        "  display: flex !important;\n"
        "  justify-content: flex-start !important;\n"
        "  align-items: center !important;\n"
        "  margin: 0 !important;\n"
        ...
        "}\n"
        "[data-test-chart-name*='Proyectos'] .input-wrapper input {\n"
