...
def persist_dashboard_config(
    ...
    dashboard_css = (
        ...
        "}\n"
        "/*\n"
        " * Fit-to-viewport (sin JS de altura):\n"
        " * - El shell no puede usar 100dvh si ya empieza bajo el menú (provoca scroll).\n"
        " * - Resta solo el offset real desde arriba (--ps-dash-top / --ps-tables-top).\n"
        " */\n"
        ":root {\n"
        "  --ps-dash-top: 126px;\n"
        "  --ps-tables-top: 510px;\n"
        ...
        "  overflow: hidden !important;\n"
        "}\n"
        "/* Tablas Resumen: ocupan el hueco restante bajo KPIs (autoresize por resolución) */\n"
        ...
        ".dragdroppable:has([data-test-chart-name*='Resumen mensual']),\n"
        ".dragdroppable:has([data-test-chart-name*='Proyectos']) {\n"
