...
def persist_dashboard_config(
    ...
    dashboard_css = (
        ...
        "  overflow: hidden !important;\n"
        "}\n"
        "/* Grid interno: misma altura desde el 1er paint (evita AG corto→alto) */\n"
        ".ant-tabs-tabpane-active:has([data-test-chart-name*='Gastos'])\n"
        " [data-test-chart-name*='Gastos'] .chart-slice,\n"
        ".ant-tabs-tabpane-active:has([data-test-chart-name*='Gastos'])\n"
        ...
        "  height: calc(var(--ps-gastos-h) - 56px) !important;\n"
        "  max-height: calc(var(--ps-gastos-h) - 56px) !important;\n"
        "  min-height: calc(var(--ps-gastos-h) - 56px) !important;\n"
        "}\n"
        ...
        "/* Upstream apache/superset#42115: AG Grid 36 deja opacity:0 en pinned bottom */\n"
        "[data-test-chart-name*='Resumen mensual'] .ag-row-pinned,\n"
        "[data-test-chart-name*='Proyectos'] .ag-row-pinned,\n"
        "[data-test-chart-name*='Gastos'] .ag-row-pinned {\n"
        "  opacity: 1 !important;\n"
        "}\n"
