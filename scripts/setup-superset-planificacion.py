...
def persist_dashboard_config(
    ...
    dashboard_css = (
        ...
        "  height: calc(var(--ps-gastos-h) - 48px) !important;\n"
        "  max-height: calc(var(--ps-gastos-h) - 48px) !important;\n"
        "  min-height: calc(var(--ps-gastos-h) - 48px) !important;\n"
        "}\n"
        ...
        "  display: none !important;\n"
        "}\n"
        "/* Gastos: fila de totales siempre visible (no clip por overflow del card) */\n"
